...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "8182107643:AAHG8DvOiLCKvZ6UHl92_bZCqbqEaBV7VhQ")
...
#OWNER ID
OWNER_ID = int(os.environ.get("OWNER_ID", "7035751998 7773760478"))
...
FORCESUB_CHANNEL = int(os.environ.get("FORCESUB_CHANNEL", "-1002656606106"))
...
#start message
START_MSG = os.environ.get("START_MESSAGE", "<b>ʜɪ ᴛʜᴇʀᴇ... {first}! 💥\n\nɪ ᴀᴍ ᴀ ꜰɪʟᴇ ꜱᴛᴏʀᴇ ʙᴏᴛ...!\nɪ ᴄᴀɴ ᴘʀᴏᴠɪᴅᴇ ᴘʀɪᴠᴀᴛᴇ ꜰɪʟᴇꜱ ᴛʜʀᴏᴜɢʜ ᴀ ꜱᴘᴇᴄɪꜰɪᴄ ʟɪɴᴋ....!\n\nᴘᴏᴡᴇʀᴇᴅ ʙʏ : <a href=https://t.me/Adult_Flame>𝐀𝐝𝐮𝐥𝐭 𝐅𝐥𝐚𝐦𝐞 𝐍𝐞𝐭𝐰𝐨𝐫𝐤</a></b>")
try:
    ADMINS=[1418213560]
...
USER_REPLY_TEXT = "Pʟᴇᴀꜱᴇ ᴅᴏɴ'ᴛ ᴍᴇꜱꜱᴀɢᴇ ᴍᴇ ᴅɪʀᴇᴄᴛʟʏ ɪ ᴀᴍ ᴏɴʟʏ ᴡᴏʀᴋ ꜰᴏʀ - @Adult_Flame"
